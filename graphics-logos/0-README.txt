...
3) Open the "skin.xml" search and replace the variable "mylogo"´s value by "1", "2", "3", "4", "5", etc...
(Set the variable to the number of the "logo_x.svg" file that you intend to be displayed)
...
IMPORTANT: Your new created "logo_x.svg" file name must be similar to these examples:
